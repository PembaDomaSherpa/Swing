...
public class TabbedPaneFrame extends JFrame {
    ...
    public TabbedPaneFrame(){
        ...
        ImageIcon icon= new ImageIcon(getClass().getResource("yellow.png"));
        ...
        tabbedPane.addTab("Plutao", icon , null);
        ...
        tabbedPane.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                if(tabbedPane.getSelectedComponent()==null){
                    ...
                    tabbedPane.setIconAt(n, new ImageIcon(getClass().getResource("red.png")));
                }
            }
        });
